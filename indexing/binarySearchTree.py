...
class BinarySearchTree:
    ...
    def isEmpty(self) -> bool:
        return self.__root == self is None
    ...
    def __preorder(self, tNode:TreeNode):
        if (tNode != None):
            print(tNode.item, end=" ")
            self.__preorder(tNode.left)
            self.__preorder(tNode.right)
    
    def inorder(self):
        self.__inorder(self.__root)
     
    def __inorder(self, tNode:TreeNode):
        if (tNode != None):
            self.__inorder(tNode.left)
            print(tNode.item, end=" ")
            self.__inorder(tNode.right)
    
    def postorder(self):
        self.__postorder(self.__root)

    def __postorder(self, tNode:TreeNode):
        if (tNode != None):
            self.__postorder(tNode.left)
            self.__postorder(tNode.right)
            print(tNode.item, end=" ")
            
    def lca(self, pv:TreeNode, qv:TreeNode):
        p = self.search(pv)
        q = self.search(qv)
